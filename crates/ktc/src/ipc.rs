...
use ktc_common::{IpcCommand, IpcEvent, WorkspaceInfo, ipc_socket_path};
...
impl IpcServer {
    ...
    pub fn send_state(&mut self, workspaces: Vec<WorkspaceInfo>, active: usize, focused_title: Option<String>) {
